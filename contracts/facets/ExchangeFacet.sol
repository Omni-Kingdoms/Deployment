...
//         require(msg.value >= ex.equipmentListings[_listingId].price, "you are not sending enough"); //check to make sure user is sending correct value
//         // send 1% to the treasury account from the buyer
//         // send 99% to the seller
//         // add player id to the buyer
//         // remove id from listing array
//         // remove id from address to listings array
//         // delet the listing from mapping
...
//     function _getEquipmentListingsByAddress(address _address) internal view returns (uint256[] memory) {
//         ExchangeStorage storage ex = diamondStorageEx();
//         return ex.addressToEquipmentListings[_address];
//     }

//     function _getEquipmentListing(uint256 _listingId) internal view returns (EquipmentListing memory) {
//         ExchangeStorage storage ex = diamondStorageEx();
//         return ex.equipmentListings[_listingId];
//     }

//     function _getAllEquipmentListings() internal view returns (uint256[] memory) {
//         ExchangeStorage storage ex = diamondStorageEx();
//         return ex.equipmentListingsArray;
//     }
